...
@implementation EMTLOldPhotoCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        favoritesButton.frame = CGRectMake(16, 347, [EMTLOldPhotoCell favoritesStringWidth], 16);
        favoritesButton.titleLabel.font = [EMTLOldPhotoCell favoritesFont];
        ...
        commentsButton.frame = CGRectMake(16, 369, [EMTLOldPhotoCell commentsStringWidth], 16);
        commentsButton.titleLabel.font = [EMTLOldPhotoCell commentsFont];
